                ...
                <div className="final_div">
                    <div className="Description_div">
                        <span
                            style={{
                                color: `${
                                    desc ? "rgb(252, 39, 121)" : "black"
                                }`,
                                borderBottom: `${
                                    desc
                                        ? " 1px solid rgb(252, 39, 121)"
                                        : "black"
                                }`,
                            }}
