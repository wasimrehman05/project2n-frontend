                ...
                <div className="contact-wrapper">
                    <div className="email">
                        ...
                        <div className="email-send" style={{ display: "flex" }}>
                            <input
                                ...
                                style={{ borderbelow: "1px solid black" }}
                            />
                            <div
                                style={{
                                    padding: "2%",
                            ...
                            >
                                <span
                                    className="footer-text bold send"
                                    style={{ fontSize: "19px" }}
                                >
                                    SEND
                                </span>
                    ...
                    <div className="app">
                        ...
                        <div className="appstore" style={{ display: "flex" }}>
                            <div>
                                <img
                                    className="app-img"
                                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRtW2CxVO2RXB--dHwFVDpn7kKWu5tQ90b-Qi6YKQ-1sI90eYvMaEWZytRLX-1aymKRNg&usqp=CAU"
                                    alt="google play"
                                    style={{ width: "90%" }}
                                />
                            </div>
                    ...
                    <div className="phone">
                        ...
                        <div className="phone-text-div">
                            <div>
                                <p className="footer-text  bold phone-text">
                                    (Monday to Saturday, 8AM to 10PM and Sunday,
                                    10AM to 7PM)
                                </p>
                            </div>
                        </div>
            ...
            <div className="services-footer">
                <div className="services-wrapper">
                    ...
                    <div className="service-authentic service">
                        ...
                        <div>
                            <p className="heading-service">
                                AUTHENTIC PRODUCTS
                            </p>
                            <hr />
                            <p className="desc-service">
                                Sourced Directly from Brands/ Authorised
                                Distributors
                            </p>
                        </div>
                    </div>
